...
class ERROR_MESSAGES(str, Enum):
    ...
    CELL_PHONE_TAKEN = "Uh-oh! This cell-phone number is already registered. Sign in with your existing account or choose another cell-phone number to start anew."
    USERNAME_TAKEN = (
    ...
    INVALID_CRED_CELL_PHONE = "The cell-phone number or password provided is incorrect. Please check for typos and try logging in again."
